...
## 5. Verify a commit across platforms

Use `mana-agent fleet verify` after trusted workers have enrolled and Fleet is
enabled. Required platforms and argv commands are explicit; missing coverage
stops before execution. See
[cross-platform verification](25-cross-platform-verification.md).
