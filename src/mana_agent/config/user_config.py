...
DEFAULT_USER_CONFIG: dict[str, Any] = {
    ...
    "MANA_ROUTING_TASK_TOKEN_BUDGET": 1000000,
    ...
    "MANA_API_TOKEN": "",
    "MANA_API_MANAGER_ALLOWED_HOSTS": "",
    "MANA_API_MANAGER_TRUSTED_INTERNAL_HOSTS": "",
    "MANA_API_MANAGER_TRUSTED_INTERNAL_NETWORKS": "",
...
FIELD_NAME_BY_ENV: dict[str, str] = {
    ...
    "MANA_CONTEXT_GOVERNOR_ENABLED": "mana_context_governor_enabled",
    "MANA_CONTEXT_GOVERNOR_MODE": "mana_context_governor_mode",
    "MANA_CONTEXT_WARNING_RATIO": "mana_context_warning_ratio",
    "MANA_CONTEXT_COMPACT_RATIO": "mana_context_compact_ratio",
    "MANA_CONTEXT_MAX_UTILIZATION": "mana_context_max_utilization",
    "MANA_CONTEXT_HARD_LIMIT_RATIO": "mana_context_hard_limit_ratio",
    "MANA_CONTEXT_RESPONSE_RESERVE_RATIO": "mana_context_response_reserve_ratio",
    "MANA_CONTEXT_RESPONSE_RESERVE_TOKENS": "mana_context_response_reserve_tokens",
    "MANA_CONTEXT_TOOL_RESULT_MAX_TOKENS": "mana_context_tool_result_max_tokens",
    "MANA_CONTEXT_HISTORY_MAX_TOKENS": "mana_context_history_max_tokens",
    "MANA_CONTEXT_RETRIEVAL_MAX_TOKENS": "mana_context_retrieval_max_tokens",
    "MANA_CONTEXT_LAZY_CAPABILITIES": "mana_context_lazy_capabilities",
    "MANA_CONTEXT_CAPABILITY_IDLE_STEPS": "mana_context_capability_idle_steps",
    "MANA_CONTEXT_ARTIFACT_RETENTION_DAYS": "mana_context_artifact_retention_days",
    "MANA_CONTEXT_COST_LOG_ENABLED": "mana_context_cost_log_enabled",
    "MANA_CONTEXT_COST_LOG_RETENTION_DAYS": "mana_context_cost_log_retention_days",
    "MANA_CONTEXT_ESTIMATION_SAFETY_MARGIN_RATIO": "mana_context_estimation_safety_margin_ratio",
    "MANA_CONTEXT_DEFAULT_OUTPUT_RATIO": "mana_context_default_output_ratio",
    "MANA_CONTEXT_HISTORICAL_PREDICTION_ENABLED": "mana_context_historical_prediction_enabled",
    "MANA_CONTEXT_UNKNOWN_MODEL_POLICY": "mana_context_unknown_model_policy",
    "MANA_CONTEXT_UNKNOWN_MODEL_CONTEXT_WINDOW": "mana_context_unknown_model_context_window",
    "MANA_CONTEXT_UNKNOWN_MODEL_MAX_OUTPUT_TOKENS": "mana_context_unknown_model_max_output_tokens",
    ...
    "MANA_EXECUTION_SUPERVISOR_ENABLED": "mana_execution_supervisor_enabled",
    "MANA_EXECUTION_SUPERVISOR_LEASE_SECONDS": "mana_execution_supervisor_lease_seconds",
    "MANA_EXECUTION_SUPERVISOR_HEARTBEAT_SECONDS": "mana_execution_supervisor_heartbeat_seconds",
    "MANA_EXECUTION_SUPERVISOR_CHECKPOINT_SECONDS": "mana_execution_supervisor_checkpoint_seconds",
    "MANA_EXECUTION_SUPERVISOR_RETRY_BUDGET": "mana_execution_supervisor_retry_budget",
    "MANA_EXECUTION_SUPERVISOR_MAX_REPLANS": "mana_execution_supervisor_max_replans",
    "MANA_EXECUTION_SUPERVISOR_MAX_CHILD_DEPTH": "mana_execution_supervisor_max_child_depth",
    "MANA_EXECUTION_SUPERVISOR_MAX_CHILDREN": "mana_execution_supervisor_max_children",
    "MANA_EXECUTION_SUPERVISOR_MAX_TOTAL_SUBTASKS": "mana_execution_supervisor_max_total_subtasks",
    "MANA_EXECUTION_SUPERVISOR_MAX_CONCURRENT_CHILDREN": "mana_execution_supervisor_max_concurrent_children",
    "MANA_EXECUTION_SUPERVISOR_STARTUP_RECOVERY": "mana_execution_supervisor_startup_recovery",
    "MANA_EXECUTION_SUPERVISOR_VERIFY_ARTIFACTS": "mana_execution_supervisor_verify_artifacts",
    "MANA_EXECUTION_SUPERVISOR_ALLOW_UNKNOWN_RETRY": "mana_execution_supervisor_allow_unknown_retry",
}
...
CONFIG_WRITE_ORDER = [
    ...
    "MANA_LLM_SUPPORTS_REASONING",
    "MANA_LLM_SUPPORTS_TOOLS_WITH_CHAT_REASONING",
    "MANA_CONTEXT_GOVERNOR_ENABLED",
    "MANA_CONTEXT_GOVERNOR_MODE",
    "MANA_CONTEXT_WARNING_RATIO",
    "MANA_CONTEXT_COMPACT_RATIO",
    "MANA_CONTEXT_MAX_UTILIZATION",
    "MANA_CONTEXT_HARD_LIMIT_RATIO",
    "MANA_CONTEXT_RESPONSE_RESERVE_RATIO",
    "MANA_CONTEXT_RESPONSE_RESERVE_TOKENS",
    "MANA_CONTEXT_TOOL_RESULT_MAX_TOKENS",
    "MANA_CONTEXT_HISTORY_MAX_TOKENS",
    "MANA_CONTEXT_RETRIEVAL_MAX_TOKENS",
    "MANA_CONTEXT_LAZY_CAPABILITIES",
    "MANA_CONTEXT_CAPABILITY_IDLE_STEPS",
    "MANA_CONTEXT_ARTIFACT_RETENTION_DAYS",
    "MANA_CONTEXT_COST_LOG_ENABLED",
    "MANA_CONTEXT_COST_LOG_RETENTION_DAYS",
    "MANA_CONTEXT_ESTIMATION_SAFETY_MARGIN_RATIO",
    "MANA_CONTEXT_DEFAULT_OUTPUT_RATIO",
    "MANA_CONTEXT_HISTORICAL_PREDICTION_ENABLED",
    "MANA_CONTEXT_UNKNOWN_MODEL_POLICY",
    "MANA_CONTEXT_UNKNOWN_MODEL_CONTEXT_WINDOW",
    "MANA_CONTEXT_UNKNOWN_MODEL_MAX_OUTPUT_TOKENS",
