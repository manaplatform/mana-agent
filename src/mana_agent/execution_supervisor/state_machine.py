...
TRANSITIONS: dict[ExecutionState, frozenset[ExecutionState]] = {
    ...
    ExecutionState.RUNNING: frozenset({ExecutionState.CHECKPOINTING, ExecutionState.WAITING, ExecutionState.RETRY_SCHEDULED, ExecutionState.REPLANNING, ExecutionState.CANCELLING, ExecutionState.FAILED, ExecutionState.BUDGET_EXHAUSTED, ExecutionState.PENDING_BUDGET_DECISION, ExecutionState.COMPLETED_PENDING_VERIFICATION}),
    ...
    ExecutionState.WAITING: frozenset({ExecutionState.QUEUED, ExecutionState.LEASED, ExecutionState.RUNNING, ExecutionState.CHECKPOINTING, ExecutionState.RETRY_SCHEDULED, ExecutionState.REPLANNING, ExecutionState.CANCELLING, ExecutionState.FAILED, ExecutionState.BUDGET_EXHAUSTED, ExecutionState.PENDING_BUDGET_DECISION, ExecutionState.COMPLETED_PENDING_VERIFICATION}),
