...
TRANSITIONS: dict[ExecutionState, frozenset[ExecutionState]] = {
    ...
    ExecutionState.CHECKPOINTING: frozenset({ExecutionState.RUNNING, ExecutionState.WAITING, ExecutionState.RETRY_SCHEDULED, ExecutionState.CANCELLING, ExecutionState.FAILED, ExecutionState.BUDGET_EXHAUSTED, ExecutionState.RECOVERY_REVIEW_REQUIRED, ExecutionState.COMPLETED_PENDING_VERIFICATION, ExecutionState.PENDING_BUDGET_DECISION}),
    ...
    ExecutionState.COMPLETED_PENDING_VERIFICATION: frozenset({ExecutionState.COMPLETED, ExecutionState.CHECKPOINTING, ExecutionState.RETRY_SCHEDULED, ExecutionState.REPLANNING, ExecutionState.CANCELLING, ExecutionState.FAILED}),
    ExecutionState.PENDING_BUDGET_DECISION: frozenset({ExecutionState.COMPLETED, ExecutionState.CHECKPOINTING, ExecutionState.WAITING, ExecutionState.RETRY_SCHEDULED, ExecutionState.REPLANNING, ExecutionState.CANCELLING, ExecutionState.FAILED}),
