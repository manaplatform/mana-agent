...
When the work is the same, does not require fresh data, and is safe to continue, you must select
resume_checkpoint or retry_task for the applicable candidate; do not select start_fresh. Select
